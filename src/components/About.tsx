    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div>
            <p className="text-xl text-gray-600 leading-relaxed mb-6 hover:text-gray-800 transition-colors duration-300 animate-fadeInUp text-justify">
            ...
            <p className="text-xl text-gray-600 leading-relaxed hover:text-gray-800 transition-colors duration-300 animate-fadeInUp text-justify">
